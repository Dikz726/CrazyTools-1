...
// Elemen Pop-up Modal Selamat
const congratsModal = document.getElementById("congrats-modal");
const modalTitle = document.getElementById("modal-title");
const modalWinner = document.getElementById("modal-winner");
const closeModalBtn = document.getElementById("close-modal-btn");

// Array Utama & Variabel Penampung Pemenang Sementara
let options = [];
let lastWinnerIndex = null; 
let leaderboardData = {};

// Palet warna cyberpunk roda
...
// ============================================================
// MANAGEMENT INPUT DATA & PASTE HANDLER
// ============================================================
function updateTags() {
...
// ============================================================
// LOGIKA ANIMASI PUTAR RODA & TRIGGER SELECTION
// ============================================================
...
// SOLUSI TERBAIK & AMAN: Intersep teks saat user melakukan paste ke input box
optionInput.addEventListener("paste", (e) => {
    e.preventDefault(); // Matikan paste bawaan input box agar tidak numpuk teks satu baris
...
// Aksi Klik Tombol Paste Pintar
pasteBtn.addEventListener("click", async () => {
    // Jalankan fallback utama dulu untuk browser standar (Modern Security)
    try {
        const clipboardText = await navigator.clipboard.readText();
        if (clipboardText.trim() !== "") {
            processBulkInput(clipboardText);
            return; // Sukses langsung keluar fungsi
        }
    } catch (err) {
        // Jika diblokir keamanan HTTPS browser, jalankan Trik Fokus Otomatis ini:
        optionInput.focus();
        
        // Coba picu fungsi paste dokumen internal browser
        try {
            document.execCommand("paste");
        } catch (execErr) {
            // Jika eksekusi dokumen masih super ketat, beri info interaktif ke user:
            ...
            // Kembalikan placeholder normal setelah 4 detik
            setTimeout(() => {
...
// Aksi ketika tombol modal ditutup (Proses Eliminasi)
